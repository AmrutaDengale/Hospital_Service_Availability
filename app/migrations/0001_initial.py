# Generated by Django 3.1.1 on 2022-05-13 16:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oxygen_cyliender_available', models.IntegerField(default=0)),
                ('ventilator_total', models.IntegerField(default=0)),
                ('ventilator_available', models.IntegerField(default=0)),
                ('city', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='app.hospital')),
            ],
        ),
        migrations.AddField(
            model_name='city',
